...
void fixOverlay() {
  ...
  void setup_style(TH1* histo, std::string xtitle, std::string ytitle, int lcolor, bool fill, bool stat)
  { 
  ...
  void setup_style_data(TH1* histo, std::string xtitle, std::string ytitle, int lcolor, bool fill, bool stat)
  {
